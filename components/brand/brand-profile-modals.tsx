          ...
          >
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button
                type="button"
                onClick={onConfirm}
                className="flex-1 rounded-full bg-accent px-4 py-2.5 text-sm font-semibold text-white shadow-[0_4px_14px_rgba(94, 80, 235,0.25)]"
              >
                Refresh profile
              </button>
            </div>
          ...
          >
            ...
            <div className="mt-6 flex flex-col gap-2 sm:flex-row">
              ...
              <button
                ...
                onClick={onDiscard}
                disabled={saving}
                className="btn-outline-warm flex-1 text-sm disabled:opacity-60"
              >
                Discard
              </button>
              <button
