...
const STEPS = [
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden>
        <circle cx="9" cy="9" r="7" stroke="#6947ff" strokeWidth="1.3" />
        <path
          d="M6 9H12M9 6V12"
          stroke="#6947ff"
          strokeWidth="1.3"
...
const OUTCOME_CARDS = [
  {
    ...
    description:
      "Multiple AI agents stress-test your hook, angle, and CTA before you spend.",
    accentBar: "border-t-2 border-accent/20",
    iconBg: "bg-accent/10",
    accent: "#6947ff",
    icon: (
  ...
  },
  {
    ...
    description: "See where your funnel leaks — from ad click to checkout CTA.",
    accentBar: "border-t-2 border-[#0d9488]/20",
    iconBg: "bg-[#0d9488]/10",
    accent: "#0d9488",
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden>
        <path
          d="M4 16L8 10L12 13L18 5"
          stroke="#0d9488"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    accentBar: "border-t-2 border-[#3b2b9f]/20",
    iconBg: "bg-[#3b2b9f]/10",
    accent: "#3b2b9f",
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden>
        <circle cx="11" cy="7" r="3.5" stroke="#3b2b9f" strokeWidth="1.5" />
        <path
          d="M5 19C5 15 8 13 11 13C14 13 17 15 17 19"
          stroke="#3b2b9f"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
