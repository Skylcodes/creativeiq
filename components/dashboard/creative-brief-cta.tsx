  ...
  if (size === "card") {
    return (
      <motion.div whileHover={{ y: -2 }} className={className}>
        <Link
          href="/brief/new"
          className="group flex h-full flex-col rounded-2xl bg-white/80 p-5 ring-1 ring-black/[0.06] transition-all hover:bg-white hover:shadow-[0_12px_36px_rgba(217,119,6,0.12)] hover:ring-[#d97706]/20"
        >
          ...
          <p className="mt-1.5 flex-1 text-sm leading-relaxed text-text-secondary">
            Don&apos;t have an ad yet? Get a full production brief before you film anything.
          </p>
        ...
        >
          <span className="inline-flex items-center gap-2 font-semibold text-[#d97706]">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden>
              ...
              <path d="M6 6H12M6 9H10" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
            </svg>
            Generate Creative Brief
          </span>
    ...
    <div className={`flex flex-col items-start gap-1 ${className}`}>
      ...
      >
        <svg width="15" height="15" viewBox="0 0 16 16" fill="none" aria-hidden>
          ...
          <path d="M5 5H11M5 8H9" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
        </svg>
        Generate Brief
      </Link>
