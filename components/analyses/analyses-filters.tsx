    ...
    <div className="space-y-3">
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl bg-white py-2.5 pl-10 pr-4 text-sm text-text-primary ring-1 ring-black/[0.06] transition-all placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-accent/25"
        />
      </div>
  ...
  return (
    <label className="flex min-w-[160px] flex-1 items-center gap-2 text-sm lg:flex-none">
      ...
      <select
        ...
        className="w-full rounded-xl bg-white px-3 py-2 text-sm font-medium text-text-primary ring-1 ring-black/[0.06] transition-all focus:outline-none focus:ring-2 focus:ring-accent/25"
      >
        {options.map((option) => (
