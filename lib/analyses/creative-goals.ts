...
Evaluate as a direct response ad. Hook must stop scroll and create desire. Offer must be clear and compelling. CTA must be direct. Landing page alignment is critical. Score harshly on friction between ad and purchase decision.`;
...
Evaluate urgency, offer clarity, and specificity. Is the deal immediately obvious? Is urgency genuine (real deadline, discount amount, quantity limit) vs vague manufactured urgency? Does the offer stand out? Landing page must match the exact deal shown in the ad.`;
...
- social_proof (10): reduced weight — not primary for awareness
...
- brand_memorability (15): REPLACE funnel_continuity — will viewers remember this brand? Distinctive identity, emotional stickiness, shareability signals

Do NOT include funnel_continuity. Use key "brand_memorability" with label "Brand Memorability", maxScore 15.`;
...
- hook_strength (15)
- social_proof (15)
- lead_magnet_clarity (20): REPLACE offer_clarity — is the value exchange for the lead unmistakable?
- objection_handling (15): friction and trust around giving information
- visual_ux (10)
- funnel_continuity (5): reduced weight — destination may be a simple form

Use key "lead_magnet_clarity" with label "Lead Magnet Clarity", maxScore 20. Reduce funnel_continuity maxScore to 5.`;
...
Increase objection_handling maxScore to 25. Reduce hook_strength maxScore to 10.`;
...
- hook_strength (15)
- social_proof (10)
- offer_clarity (25): INCREASED — deal specificity and urgency
...
- hook_strength (20): curiosity and novelty in first impression
- social_proof (10)
...
- message_match (20), hook_strength (15), social_proof (15), offer_clarity (15), objection_handling (15), visual_ux (10), funnel_continuity (10)`;
  }
}
